...
function DialogHeader({
  ...
  if (React__default.Children.toArray(children).every(ch => typeof ch === 'string')) {
  ...
  return /*#__PURE__*/React__default.createElement(DialogHeaderBase, _extends({
    theme: theme,
    p: 3,
...
const Dialog = /*#__PURE__*/forwardRef(({
  ...
  return isOpen ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Overlay, {
    ref: overlayRef
  }), /*#__PURE__*/React__default.createElement(DialogBase, _extends({
    tabIndex: -1,
    ref: modalRef,
    role: "dialog",
    "aria-modal": "true"
  }, props, getDialogProps()), /*#__PURE__*/React__default.createElement(ButtonClose, {
    ref: closeButtonRef,
