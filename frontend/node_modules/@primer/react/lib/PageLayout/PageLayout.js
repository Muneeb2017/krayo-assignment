...
var useOverflow = require('../utils/useOverflow.js');
...
const Pane = /*#__PURE__*/React__default.default.forwardRef(({
  ...
  if (hasOverflow) {
    !(label !== undefined || labelledBy !== undefined) ? process.env.NODE_ENV !== "production" ? invariant.invariant(false) : invariant.invariant(false) : void 0;
    if (labelledBy) {
      labelProp = {
        'aria-labelledby': labelledBy
      };
